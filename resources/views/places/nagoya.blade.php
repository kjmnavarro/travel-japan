...
@section('title', 'Japan - Nagoya')

@section('content')

    <div id="banner-nagoya">
        <div class="place-text">
            <h1>Nagoya</h1>
            <p>With over two million inhabitants, Nagoya is Japan's fourth most populated city. It is the capital of Aichi Prefecture and the principal city of the Nobi plain, one of Honshu's three large plains and metropolitan and industrial centers</p>
            <span>Temp: <span class="text-warning">{{ $nagoya_data['main']['temp'] - 273.15 }} &deg;C</span></span><br>
            <span>Clouds: <span class="text-warning">{{ $nagoya_data['clouds']['all'] }}%</span></span><br>
            <span>Temp: <span class="text-warning">{{ $nagoya_data['main']['humidity'] }}%</span></span><br>
            <span>Pressure: <span class="text-warning">{{ $nagoya_data['main']['pressure'] }}hPa</span></span><br>
            <span>Wind Direction: <span class="text-warning">{{ $nagoya_data['wind']['deg'] }}&deg;</span></span><br>
            <span>Wind Speed: <span class="text-warning">{{ $nagoya_data['wind']['speed'] }}m/s</span></span><br>
        </div>
    </div>
