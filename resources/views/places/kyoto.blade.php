...
@section('content')
    ...
    <div id="banner-kyoto">
        <div class="place-text">
            <h1>Kyoto</h1>
            <p>Kyoto served as Japan's capital and the emperor's residence from 794 until 1868.</p>
            <span>Temp: <span class="text-warning">{{ $kyoto_data['main']['temp'] - 273.15 }} &deg;C</span></span><br>
            <span>Clouds: <span class="text-warning">{{ $kyoto_data['clouds']['all'] }}%</span></span><br>
            <span>Temp: <span class="text-warning">{{ $kyoto_data['main']['humidity'] }}%</span></span><br>
            <span>Pressure: <span class="text-warning">{{ $kyoto_data['main']['pressure'] }}hPa</span></span><br>
            <span>Wind Direction: <span class="text-warning">{{ $kyoto_data['wind']['deg'] }}&deg;</span></span><br>
            <span>Wind Speed: <span class="text-warning">{{ $kyoto_data['wind']['speed'] }}m/s</span></span><br>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-8 pl-0 pr-0 pb-0 mb-0">
                <div class="attr1 attr_kyoto1"></div>
            </div>
            <div class="col-md-4 pb-0 mb-0 pl-0 pr-0">
                <div class="d-flex flex-column">
                  ...
                  <div class="attr2 attr_kyoto2 pr-0 pl-0"></div>
                </div>
            </div>
            ...
            <div class="col-md-4 pb-0 mb-0 pr-0 pl-0">
                <div class="d-flex flex-column">
                  ...
                  <div class="acco1 acco_kyoto1 pr-0 pl-0"></div>
                </div>
            </div>

            <div class="col-md-8 pr-0 pl-0 pb-0 mb-0">
                <div class="acco2 acco_kyoto2"></div>
            </div>

            <div class="col-md-4 pr-0 pl-0 pb-0 mb-0">
                <div class="food1 food_kyoto1 pr-0 pl-0"></div>
            </div>
            ...
            <div class="col-md-4 pr-0 pl-0 pb-0 mb-0">
                 <div class="food2 food_kyoto2 pr-0 pl-0"></div>
            </div>
